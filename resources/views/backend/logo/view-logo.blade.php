                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ (!empty($logo->image))?url('upload/logo_images/'. $logo->image):url('upload/no_image.png') }}" width="120px" height="130px"></td>
                            
                            <td>
                              <a title="Edit" class="btn btn-sm btn-primary" href="{{ route('logos.edit',$logo->id) }}"> <i class="fa fa-edit"></i> </a>

                              <a title="Delet" id="delete" class="btn btn-sm btn-danger" href="{{ route('logos.delet',$logo->id) }}"> <i class="fa fa-trash"></i> </a>
                            </td>
                        </tr>
