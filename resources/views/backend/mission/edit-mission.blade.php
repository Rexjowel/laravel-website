                ...
                <form method="post" action="{{ route('missions.update',$editData->id) }}" id="myForm" enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2">
                            <img id="showImage" src="{{ (!empty($editData->image))?url('upload/mission_images/'. $editData->image):url('upload/no_image.png') }}"" style="width: 150px; height: 160px; bordered:1px solid #000;">
                        </div>
